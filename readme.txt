...
1. Popup Search upton pressing Ctrl + Shift + Space bar ( Command + Shift + Space bar for Mac)
2. Popup Search at the bottom right corner of the website
3. Settings for customizing Spotlight Search

== Changelog ==

= v - 1.0.0 (November 6, 2022) =
 * Initial release